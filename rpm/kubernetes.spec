...
make WHAT="cmd/kube-apiserver cmd/kube-controller-manager cmd/kube-proxy cmd/kubelet cmd/kubectl plugin/cmd/kube-scheduler"
...
install -p -m 755 rpm/loopback %{buildroot}/opt/cni/bin/loopback
